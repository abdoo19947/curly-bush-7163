...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/curly-bush-7163)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/curly-bush-7163
```

A live public deployment of this template is available at [https://curly-bush-7163.templates.workers.dev](https://curly-bush-7163.templates.workers.dev)
